...
\begin{figure}[h]
  \centering
  \includegraphics[width=1\linewidth]{figures/mount-power-01}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=1\linewidth]{figures/mount-power-02}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=1\linewidth]{figures/mount-power-03}
