...
In this chapter we have studied the power and power-on reset circuits of the Artemisa computer. We
have seen how the power connector is used to energize the system and how the power-on reset circuit
generates a reset pulse when the power is connected. We have also seen how the reset button can be
used to generate a new reset pulse without disconnecting the power adapter. Finally, we have
assembled and tested these circuits step-by-step.

In the next chapter we will study the clock circuit of the Artemisa computer. We will see how to
make a Pierce oscillator with a crystal and a few auxiliary components, and how to divide the clock
signal by two to generate a clock input for the PSG. 
